...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ListCopyPaths.setToolTip(_translate("Dialog",
                                                 "<html><head/><body><p>The found items that will be copied to the specified collection path.</p></body></html>"))
        self.ListIgnorePaths.setToolTip(_translate("Dialog",
                                                   "<html><head/><body><p>The found items that will not be copied to the specified collection path.</p></body></html>"))
        ...
        self.PackedPath.setToolTip(_translate("Dialog",
                                              "<html><head/><body><p>The location of the folder to collect all data to.<br/>Make sure this is an empty folder.</p></body></html>"))
        self.ChoosePackedPathButton.setToolTip(_translate("Dialog",
                                                          "<html><head/><body><p>The location of the folder to collect all data to.<br/>Make sure this is an empty folder.</p></body></html>"))
        ...
        self.LPackedItemPath.setToolTip(_translate("Dialog",
                                                   "<html><head/><body><p>Preview of the selected item\'s new path - after it is collected.</p></body></html>"))
        ...
        self.LWebsite.setText(_translate("Dialog",
                                         "<html><head/><body><p><a href=\"https://maxvanleeuwen.com/WrapItUp\"><span style=\" text-decoration: underline; color:#6bd5ff;\">maxvanleeuwen.com/WrapItUp</span></a></p></body></html>"))
        self.LPath.setToolTip(_translate("Dialog",
                                         "<html><head/><body><p>The location of the folder to collect all data to.<br/>Make sure this is an empty folder.</p></body></html>"))
        self.LPath.setText(_translate("Dialog", "collection folder:"))
        self.LFiles.setToolTip(
            _translate("Dialog", "<html><head/><body><p>File/frame count of the selected item.</p></body></html>"))
        ...
        self.Refresh.setToolTip(_translate("Dialog",
                                           "<html><head/><body><p>Recheck the current Nuke script for media and other files to collect.</p></body></html>"))
        self.Refresh.setText(_translate("Dialog", "refresh"))
        self.Start.setToolTip(_translate("Dialog",
                                         "<html><head/><body><p>Start with the current settings.<br/>One final confirmation will be shown.</p></body></html>"))
        ...
        self.LSize.setToolTip(
            _translate("Dialog", "<html><head/><body><p>Size of the selected item.</p></body></html>"))
        ...
        self.GoToFolder.setToolTip(_translate("Dialog",
                                              "<html><head/><body><p>Go to the folder of the currently selected item.<br/><br/>alt/option+shift+r</p></body></html>"))
        ...
        self.CopyFontDir.setToolTip(_translate("Dialog",
                                               "<html><head/><body><p>If the current Nuke script has a custom Project Font Path set in Settings &gt; Node, collect this directory.</p></body></html>"))
        self.CopyFontDir.setText(_translate("Dialog", "copy font directory (if any)"))
        self.CopyGizmos.setToolTip(_translate("Dialog",
                                              "<html><head/><body><p>If custom gizmos are used in this Nuke script, collect them and generate an init.py and menu.py file that installs them on a different machine.<br/><br/>This function does not work for all gizmos, as they can be dependent on other files.<br/>This does not work for plugins (.dll, .so, .dylib).</p></body></html>"))
        ...
        self.ContinueOnError.setToolTip(_translate("Dialog",
                                                   "<html><head/><body><p>Continue copying if an error occurs.<br/>If there are errors, check the log.txt file generated in the selected root folder.</p></body></html>"))
        self.ContinueOnError.setText(_translate("Dialog", "continue on error"))
        self.ExitOnFinish.setToolTip(_translate("Dialog",
                                                "<html><head/><body><p>Close Nuke entirely when the copying process is finished (or on error, if \'continue on error\' is disabled).<br/><br/>Useful for machines that are licensed using a limited number of floating licenses on a license server.</p></body></html>"))
        self.ExitOnFinish.setText(_translate("Dialog", "exit nuke on finish"))
        self.CSVSeparator.setToolTip(
            _translate("Dialog", "<html><head/><body><p>Set the log file\'s CSV column separator.</p></body></html>"))
        self.CSVSeparator.setItemText(0, _translate("Dialog", ";"))
        self.CSVSeparator.setItemText(1, _translate("Dialog", ","))
        self.LCSVSeparator.setToolTip(
            _translate("Dialog", "<html><head/><body><p>Set the log file\'s CSV column separator.</p></body></html>"))
        ...
        self.License.setToolTip(_translate("Dialog",
                                           "<html><head/><body><p>Use this flag internally when running Nuke in command-line (when relinking).<br/>The -t flag uses a nuke_r license, the -ti flag uses a nuke_i license.</p></body></html>"))
        self.License.setItemText(0, _translate("Dialog", "-t"))
        self.License.setItemText(1, _translate("Dialog", "-ti"))
        self.LLicense.setToolTip(_translate("Dialog",
                                            "<html><head/><body><p>Use this flag internally when running Nuke in command-line (when relinking).<br/>The -t flag uses a nuke_r license, the -ti flag uses a nuke_i license.</p></body></html>"))
        self.LLicense.setText(_translate("Dialog", "relink license"))
        self.GoToRootFolder.setToolTip(
            _translate("Dialog", "<html><head/><body><p>Open the currently selected folder.</p></body></html>"))
        self.GoToRootFolder.setText(_translate("Dialog", "open folder"))
        self.GoToNode.setToolTip(_translate("Dialog",
                                            "<html><head/><body><p>Go to the folder of the currently selected item.<br/><br/>alt/option+shift+r</p></body></html>"))
...
def _Start(silent=False, nk='', startnow=False, out='', nodenamefolder=True, parentdircount=3, relinked=True,
           relativerelinked=True, media=True, fonts=True, gizmos=True, csvcommas=False, licinteractive=False):
    # reset list
    ...
    def PackedPath(fullPath, i=0, nodeName='', fontFolder='', project_dir=False, settingFontPath=False):
        ...
        if i == 0:
            ...
            for c in range(parentDirCount):
                newPath += splitCleanPath[len(splitCleanPath) - (parentDirCount - c)] + (
                    '/' if not c == parentDirCount - 1 else '')
        ...
        # font directory
        if i == -4:
            newPath = WIU_PackedPath + '/' + 'FONTS' + '/' + fontFolder.split('/')[-1] + (
                ('/' + fullPath.split('/')[-1]) if not settingFontPath else '')
            return newPath
    ...
    def ProcessFile(fileFrom, fileTo, writeInit, firstInit, relinkMethod, relinkFonts):
        ...
        try:
            ...
            if relinkMethod is not -1:
                ...
                if silent:
                    print
                    '\n' + WIU_Log + 'Opening temporary Nuke comp in terminal to relink' + (
                        ' (relative)' if relinkMethod == 1 else '')
                ...
                if relinkFonts and fonts:
                    vList.append(['root', 'free_type_font_path',
                                  PackedPath(WIU_OtherData[3][0], i=-4, fontFolder=WIU_OtherData[3][0],
                                             settingFontPath=True)])  # font path
                    ...
                    for d in WIU_MediaData:
                        ...
                        for eachNode in d[0]:
                            ...
                            if (silent or (d in WIU_MediaDataNotIgnored)) and not d[6]:
                                vList.append([eachNode.fullName(), d[1][n],
                                              PackedPath(d[3], nodeName=getNodeNames(d[0], us=True), project_dir=d[6])])
                                n += 1
    ...
    def RefreshUI():
        ...
        # list count
        iCopy = 0
        item = "nk\t\t" + WIU_OtherData[0][0].split('/')[-1] if not silent else "nk\t\t\t\t" + \
                                                                                WIU_OtherData[0][0].split('/')[-1]
        if not silent:
        ...
        for dataItem in WIU_MediaData:
            ...
            item = exists + nodeName + '\t' + extraTab + dataItem[
                3] if not silent else exists + nodeName + '\t\t' + extraTab + dataItem[3]
    ...
    def UpdateLabels(CopyList):
        ...
        if len(sel) == 1:
            ...
            if (Media):
                ...
                packeditempath = PackedPath(curritempath, nodeName=getNodeNames(selData[0], us=True),
                                            project_dir=selData[6])
    ...
    def AddOnsInList(f=False, g=False):
        ...
        if WIU_Gizmo:
            ...
            for eachGizmo in range(len(WIU_OtherData) - 4):
                ...
                item = "gizmo\t\t" + WIU_OtherData[4 + eachGizmo][0] if not silent else "gizmo\t\t\t" + \
                                                                                        WIU_OtherData[4 + eachGizmo][0]
        ...
        for j in itemsToCopy:
            ...
            if k == -4:
                ...
                for eachFileS in l[2]:
                    ...
                    # set file, file path to copy to, list item index, file size in bytes, size ratio within sequence for progress bar, nodes, knobs, original index
                    fileList.append(
                        [eachFileS[0], eachFileTo, i, eachFileS[1], sequenceSizeRatio, ['root'], ['free_type_font_path'],
                         k])
    ...
    def ThreadedCopy(fileList, relinkFonts):
        ...
        params = CSV(["Used command-line/python function", str(silent)]) + '\n' + CSV(
            ["Script path", nukescript]) + '\n' + CSV(["Folders with node names", str(WIU_NodeNameFolder)]) + '\n' + CSV(
            ["Parent directory count", str(WIU_ParentDirCount)]) + '\n' + CSV(["Relinked", str(WIU_Relink)]) + '\n' + CSV(
            ["Relative relinked", str(WIU_RelinkRelative)]) + '\n' + CSV(["Fonts", str(WIU_Fonts)]) + '\n' + CSV(
            ["Gizmos", str(WIU_Gizmo)]) + '\n' + CSV(["License", 'nuke_i' if getLic() == '-ti' else 'nuke_r'])
        WriteLog(WIU_Title + '\n' + 'Nuke version: ' + nukever + '\n\n' + params + '\n\n\n' + CSV(
            ['TIME', 'STATUS', 'FILE (FROM)', 'FILE (TO)', 'NODE', 'KNOB', 'SIZE', 'RETURN']) + '\n', first=True)
        ...
        for f in fileList:
            ...
            if result == '':
                ...
                WriteLog(CSV([timestr, 'SUCCES', f[0], f[1], getNodeNames(f[5], i=f[7]), getKnobNames(f[6]),
                              BytesToString(f[3])]))
            ...
            # on error
                ...
                WriteLog(
                    CSV([timestr, 'FAILED', f[0], f[1], getNodeNames(f[5], i=f[7]), getKnobNames(f[6]), BytesToString(f[3]),
                         result]))
        ...
        total_filePath = WIU_PackedPath+'/../total_log.csv'
        try:

            # open file
            f = open(total_filePath, "a+")
            # write and close
            f.write(WIU_PackedPath.split('/')[-1]+' ---> all collected media size: '+Total_BytesToString(total_files_size) +'  ('+str(total_files_size)+ ') bytes   \n')            
            f.close()
            
            # write episodes total
             
            with open(total_filePath, "r") as infile:
                lines = infile.read().splitlines()
            episode = None 
            total = 0 
            output = [] 
            for line in lines:
                match = re.search(r"(\d+)_.*\((\d+)\) bytes", line)
                if match:
                    ep_num = int(match.group(1))
                    size = int(match.group(2))
                    if ep_num != episode:
                        if episode is not None:
                            output.append("Episode "+str(episode)+" total size: "+Total_BytesToString(total))
                        episode = ep_num
                        total = 0
                    output.append(line)
                    total += size
            ...
            # write all total            
            total_size = 0
            with open(total_filePath, 'r') as input_file:
                lines = input_file.readlines()
                lines = [line for line in lines if not line.startswith('Total size:')]
            ...
            with open(total_filePath, 'w') as output_file:
                output_file.writelines(lines)
                output_file.write('Total size: '+Total_BytesToString(total_size)+'\n')		
    ...
    def StopCopy():
        ...
        if WIU_Copying:
            ...
            if q:
                ...
                WCurrentCopyItem.setToolTip(
                    'Waiting for the current file copy to complete before stopping the copy process.')
...
def WrapItUp(fromterminal=False, nk='', startnow=False, out='', nodenamefolder=True, parentdircount=3, relinked=True,
             relativerelinked=True, media=True, fonts=True, gizmos=True, csvcommas=False, licinteractive=False):
    global WIU_AppPath
    ...
    if out is not '':
        ...
        if not os.path.isdir(out):
            err = True
            print
            WIU_Log + 'ERROR: Folder does not exist: ' + out

        if not os.path.isfile(nk):
            err = True
            print
            WIU_Log + 'ERROR: Nuke script does not exist: ' + nk

        # check if parent directory count is a valid number
        if parentdircount < 1 or parentdircount > 99:
            err = True
            print
            WIU_Log + 'ERROR: directory count (' + str(parentdircount) + ') should be in range 1-99!'
        ...
        # start
            ...
            # only print preview
            returnedFiles = _Start(silent, nk, False, out, nodenamefolder, parentdircount, relinked, relativerelinked,
                                   media, fonts, gizmos, csvcommas, licinteractive)
            returnedStr = ''
            ...
            if startnow:
                ...
                # begin
                _Start(silent, nk, startnow, out, nodenamefolder, parentdircount, relinked, relativerelinked, media,
                       fonts, gizmos, csvcommas, licinteractive)
...
if __name__ == "__main__":
    ...
    if t or ti:
        ...
        for index, arg in enumerate(c):
            if arg in ['-pd']:
                try:
                    ...
                    err = True
                    print
                    WIU_Log + 'Non-numerical value entered for -pd.'
                del c[index]
                del c[index]
                break
        ...
        if err:
            ...
            WrapItUp(fromterminal=True, nk=aNK, startnow=aStart, out=aOut, nodenamefolder=aNodeName,
                     parentdircount=aDirCount, relinked=aReli, relativerelinked=aReliRela, media=aMedia, fonts=aFonts,
                     gizmos=aGizmos, csvcommas=aCSV, licinteractive=aLicInteractive)
